...
class RecentParticipatedEventsWidget extends StatefulWidget {
  const RecentParticipatedEventsWidget({super.key});

  @override
  State<RecentParticipatedEventsWidget> createState() =>
      _RecentParticipatedEventsWidgetState();
}

class _RecentParticipatedEventsWidgetState
    extends State<RecentParticipatedEventsWidget> {
  @override
